...
from app.database import init_database, create_default_user, cleanup_stale_files
...
from app.routes.static_pages_routes import pages_bp
from app.routes.settings_routes import settings_bp
from app.routes.study_routes import study_bp
from app.routes.google_search_routes import google_search_bp
from app.routes.reels_routes import reels_bp
...
def create_app():
    ...
    def inject_nav_badges():
        ...
        if 'user' not in flask_session:
            return {}
        from app.models import User, MessageThread
