...
from app.services.ai_service import generate_course_topics, generate_topic_explanation
from app.services.youtube_service import search_youtube_videos, build_topic_video_query
