...
from app.routes.dashboard_routes import post_auth_redirect
from app.extensions import db, mail, limiter, oauth  # Assuming 'mail' is initialized in extensions.py
