...
from app.services.google_search_service import OPENSTAX_MATERIALS, search_google_pdfs
from app.services.open_textbook_library_service import search_open_textbook_library
