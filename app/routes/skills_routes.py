...
from app.services.ai_service import generate_challenge_feedback, generate_assignment_feedback, evaluate_final_project
from app.services.daily_class_service import (
