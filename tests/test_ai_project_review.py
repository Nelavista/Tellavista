...
from app.services.ai_service import evaluate_project_submission, PROJECT_REVIEW_DIMENSIONS
...
def test_overall_score_is_rounded_mean_of_dimensions_not_ai_total():
    ...
    with patch('app.services.ai_grading.requests.post', return_value=_mock_response(ai_payload)):
